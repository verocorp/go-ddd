...
| — no Go analyzer (same gap) | `TB016` compound-raw-primitive | a compound value object holds child value objects, not bare primitives (`serialization.md` rule 5's internal half; the 2026-07-20 R1 ruling). Keyed on field count: ≥2 fields makes it a compound, a single primitive field is a leaf and is untouched | `tb016/{good,bad}.py` |
